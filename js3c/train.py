...
def main(args):
    ...
    if exp_name is not None:
        experiment_dir = './JS3C-Net/log/' + exp_name
        experiment_dir = Path(experiment_dir)
        experiment_dir.mkdir(exist_ok=True)
        experiment_dir = str(experiment_dir)
    else:
        experiment_dir = Path('./JS3C-Net/log/')
        experiment_dir.mkdir(exist_ok=True)
    ...
    # shutil.copy('./JS3C-Net/train.py', str(experiment_dir))
    # shutil.copy('./JS3C-Net/kitti_dataset.py', str(experiment_dir))
    # shutil.copy('./JS3C-Net/poss_dataset.py', str(experiment_dir))
    # shutil.copy('./JS3C-Net/models/model_utils.py', str(experiment_dir))
    # shutil.copy('./JS3C-Net/models/'+args['Segmentation']['model_name'] + '.py', str(experiment_dir))
    # shutil.copy('./JS3C-Net/models/'+args['Completion']['model_name'] + '.py', str(experiment_dir))
    ...
    kitti_config = yaml.safe_load(open('./JS3C-Net/opt/semantic-kitti.yaml', 'r'))
